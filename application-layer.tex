...
\begin{card}[Hyper Text Mark-up Language]{HTML}
...
\begin{card}[Uniform Resource Name]{URN}
\item Information on the name of a resource
\end{card}

\begin{card}[Standardized General Mark-up Language]{SGML}
